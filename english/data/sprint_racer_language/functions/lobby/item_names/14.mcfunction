summon armor_stand ~ ~.8 ~ {CustomName:"{\"text\":\"Nasty Lingering Potion\",\"color\":\"white\",\"bold\":\"true\"}",CustomNameVisible:true,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore"]}
