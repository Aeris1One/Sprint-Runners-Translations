...
execute if entity @s[scores={currentTimeMsec=..4}] run title @a[tag=!noInventory,scores={actionbarState=6..8}] actionbar ["",{"text":"You're off course!","color":"red","bold":"true"}]
execute if entity @s[scores={currentTimeMsec=5..}] run title @a[tag=!noInventory,scores={actionbarState=6..8}] actionbar ["",{"text":"You're off course!","color":"dark_red","bold":"true"}]
...
execute if entity @e[name=w,tag=halftick] run function sprint_racer_language:_dlc_1/gameplay/actionbar_display_timeattack_2_echo