...
execute as @e[tag=AImaster,scores={finishPos=2}] run tellraw @a ["",{"text":"CPU_","color":"red"},{"score":{"name":"@s","objective":"rNumber"},"color":"red"},{"text":" >> [2nd]","color":"gray","bold":"true"}]
...
execute as @e[tag=AImaster,scores={finishPos=3}] run tellraw @a ["",{"text":"CPU_","color":"red"},{"score":{"name":"@s","objective":"rNumber"},"color":"red"},{"text":" >> [3rd]","color":"gold","bold":"true"}]
...
execute as @e[tag=AImaster,scores={finishPos=4}] run tellraw @a ["",{"text":"CPU_","color":"red"},{"score":{"name":"@s","objective":"rNumber"},"color":"red"},{"text":" >> [4th]","color":"white","bold":"true"}]
