...
execute if entity @e[name=cheats,type=armor_stand,tag=18a] run tellraw @s ["",{"text":"18 - SPOOKYSCARY","bold":true,"color":"white","hoverEvent":{"action":"show_text","value":"AI are skeletons."}}]
