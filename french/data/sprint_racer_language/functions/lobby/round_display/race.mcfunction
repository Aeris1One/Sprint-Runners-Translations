...
#"Round [N/5]"
execute if entity @e[name=w,scores={roundNumber=1}] run summon armor_stand 1544 85 406 {Tags:["roundDisplay","roundText1"],CustomName:"{\"text\":\"Round [1/4]\",\"color\":\"white\",\"bold\":\"true\"}",NoGravity:1,Invisible:1,Invulnerable:1,Marker:1,CustomNameVisible:1}
execute if entity @e[name=w,scores={roundNumber=2}] run summon armor_stand 1544 85 406 {Tags:["roundDisplay","roundText1"],CustomName:"{\"text\":\"Round [2/4]\",\"color\":\"white\",\"bold\":\"true\"}",NoGravity:1,Invisible:1,Invulnerable:1,Marker:1,CustomNameVisible:1}
execute if entity @e[name=w,scores={roundNumber=3}] run summon armor_stand 1544 85 406 {Tags:["roundDisplay","roundText1"],CustomName:"{\"text\":\"Round [3/4]\",\"color\":\"white\",\"bold\":\"true\"}",NoGravity:1,Invisible:1,Invulnerable:1,Marker:1,CustomNameVisible:1}
execute if entity @e[name=w,scores={roundNumber=4}] run summon armor_stand 1544 85 406 {Tags:["roundDisplay","roundText1"],CustomName:"{\"text\":\"Round [4/4]\",\"color\":\"white\",\"bold\":\"true\"}",NoGravity:1,Invisible:1,Invulnerable:1,Marker:1,CustomNameVisible:1}

#"Gamemode: X"
summon armor_stand 1544 85 406 {Tags:["roundDisplay","roundText2"],CustomName:"[\"\",{\"text\":\"Gamemode: \",\"color\":\"white\",\"bold\":\"false\"},{\"text\":\"Race\",\"color\":\"aqua\",\"bold\":\"false\"}]",NoGravity:1,Invisible:1,Invulnerable:1,Marker:1,CustomNameVisible:1}
