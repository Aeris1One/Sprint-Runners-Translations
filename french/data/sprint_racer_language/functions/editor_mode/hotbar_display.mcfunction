...
#SLOT 6
replaceitem entity @s[gamemode=creative,tag=!restricted,tag=!selecting,scores={playerState=2}] hotbar.6 minecraft:coal{display:{Name:"[\"\",{\"text\":\"RESERVED\",\"color\":\"dark_gray\",\"bold\":\"true\",\"italic\":\"false\"}]"}} 1
...
#SLOT 7
replaceitem entity @s[gamemode=creative,tag=!restricted,tag=!selecting,scores={playerState=2}] hotbar.7 minecraft:coal{display:{Name:"[\"\",{\"text\":\"RESERVED\",\"color\":\"dark_gray\",\"bold\":\"true\",\"italic\":\"false\"}]"}} 1
