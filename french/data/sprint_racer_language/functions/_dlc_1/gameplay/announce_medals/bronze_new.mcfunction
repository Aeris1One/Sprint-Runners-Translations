...
execute if entity @e[name=w,scores={gameState=7}] run scoreboard players set @e[tag=chosenTrack] medalRace 1
execute if entity @e[name=w,scores={gameState=8}] run scoreboard players set @e[tag=chosenTrack] medalBattle 1
