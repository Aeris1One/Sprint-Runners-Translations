...
execute as @a[scores={actionbarState=-10}] at @s run function sprint_racer:game_logic/3/spectator_actionbar/find_nearest_player
...
#state 1, player KO's
execute as @a[gamemode=!spectator,scores={actionbarState=1}] run function sprint_racer:game_logic/3/show_position/_index
